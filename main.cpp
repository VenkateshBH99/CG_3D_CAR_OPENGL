...
GLvoid DrawGLScene()
{
    ...
    else
    {
        ...
        //*****************************road and surrounding development***********************************
            ...
            glPushMatrix();
            glTranslatef(xw,0,0);
            glColor3f(0.93,0.78,0.68);
            glVertex3f(-100,0.1,-10);
            glVertex3f(-100,0.1,0);         //a gray surroundings
           ...
           glVertex3f(100,0.1,-10);
            ...
            glColor3f(0.93,0.78,0.68);
            glVertex3f(-100,0.1,1);
            glVertex3f(-100,0.1,100);         //a gray surroundings
            glVertex3f(100,0.1,100);
            glVertex3f(100,0.1,1);
            glPopMatrix();
        ...
        if(wheelflag)
        {
            ...
            for(i=0;i<200;i+=0.5)
            {glColor3f(0.0,0.0,0.0);
                glVertex3f(-100+i, 0.1, 0.45);
                glVertex3f(-100+i, 0.1, 0.55);
                glVertex3f(-100.3+i,0.1,0.55);
                glVertex3f(-100.3+i, 0.1, 0.45);
                glColor3f(0.7,0.7,0.7);
                glVertex3f(-100.3+i, 0.1, 0.45);
                glVertex3f(-100.3+i, 0.1, 0.55);
                glVertex3f(-100.5+i,0.1,0.55);
                glVertex3f(-100.5+i, 0.1, 0.45);
            }
            glEnd();
            glColor3f(0.0,0.0,0.0);
            ...
            {
                glVertex3f(-100+i, 0.2, 0);
                glVertex3f(-100+i+0.2, 0.2, 0);
                glVertex3f(-100+i, 0.2, 1);
                glVertex3f(-100+i+0.2, 0.2, 1);
            }
            glEnd();
            glPopMatrix();
        }
